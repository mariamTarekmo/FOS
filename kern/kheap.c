...
/* comparison between the best fit strategy and the next fit strategy :
 the best fit is better in performance but slower in speed
 while the next fit is faster but is of less performance*/
